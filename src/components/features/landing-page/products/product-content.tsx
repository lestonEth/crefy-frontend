...
function ProductContent({ activeTab }: ProductContentProps) {
  ...
  return (
    <div className="flex-1 bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-3xl shadow-2xl overflow-hidden">
      <div className="grid md:grid-cols-2 gap-8 p-12 min-h-[600px]">
        <div className="flex flex-col justify-center">
          ...
          <button className="bg-white text-gray-900 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-lg w-fit">
            View Documentation
          </button>
        </div>
